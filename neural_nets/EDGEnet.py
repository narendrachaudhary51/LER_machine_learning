...
model.add(Conv2D(64, (1, 3), padding='valid', activation = 'relu'))
model.add(BatchNormalization(axis=3))
model.add(Dropout(0.2))
...
model.add(Conv2D(64, (1, 3), padding='same', strides=(1, 2), activation = 'relu'))
model.add(BatchNormalization(axis=3))
model.add(Dropout(0.2))
...
model.add(Conv2D(64, (1, 3), padding='valid', strides=(1, 2), activation = 'relu'))
model.add(BatchNormalization(axis=3))
model.add(Dropout(0.2))
...
model.add(Conv2D(1, (1, 3), padding='same'))
