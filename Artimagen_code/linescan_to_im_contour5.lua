      ...
      for alpha = 0.1, 0.9, 0.1 do
	    ...
	    for width = 20, 30, 10 do
	          ...
	          --aig_apply_gaussian_psf(im, math.random(1,3)*0.5,1,30) -- application of the Gaussian blur
                  ...
                  local output_file = path .. 'original_images5_contour/oim_' .. tostring(sigma*1e-09) .. '_' .. tostring(alpha) .. '_' .. tostring(Xi*1e-09) .. '_' .. tostring(width) .. '_' .. tostring(space) ..'_'..tostring(-shift)..'.tiff'
